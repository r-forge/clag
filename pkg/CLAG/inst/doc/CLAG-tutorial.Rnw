...
Notice that group of elements which have a high correlation between each other are clustered together, and that elements which have low correlation with every other are left unclustered.
