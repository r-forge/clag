...
# Possible values are:
# BRAIN  BREAST  GLOBINE
CLAG.exampleData <- function(set="BREAST") {
  return(CLAG.readInput(paste(CLAG.path, "/dataCLAG/", set, "/input.txt", sep="")))
}
